...
Status: source-only notes. No Wolfram notebook, `wolframscript` command,
exported plot, or runtime output has been executed or validated in this repo.
...
| variable | meaning | current_value |
| --- | --- | --- |
